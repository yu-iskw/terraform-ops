...
// TextFormatter formats plan summaries as human-readable text
...
// Format formats a plan summary as text
func (f *TextFormatter) Format(summary *core.PlanSummary, opts core.SummaryOptions) (string, error) {
...
func (f *TextFormatter) writeHeader(builder *strings.Builder, info core.PlanInfo) {
...
func (f *TextFormatter) writeStatistics(builder *strings.Builder, stats core.Statistics) {
...
func (f *TextFormatter) writeResourceChanges(builder *strings.Builder, changes core.Changes, opts core.SummaryOptions) {
...
func (f *TextFormatter) writeActionGroup(builder *strings.Builder, title string, resources []core.ResourceSummary, opts core.SummaryOptions) {
	fmt.Fprintf(builder, "%s (%d)\n", title, len(resources))
	builder.WriteString(strings.Repeat("-", len(title)+len(fmt.Sprintf(" (%d)", len(resources)))) + "\n")
...
func (f *TextFormatter) writeResource(builder *strings.Builder, resource core.ResourceSummary, opts core.SummaryOptions) {
	// Resource address
...
func (f *TextFormatter) writeOutputChanges(builder *strings.Builder, outputs []core.OutputSummary) {
...
func (f *TextFormatter) getActionIcon(action string) string {
	switch action {
	case "create":
		return "➕"
	case "update":
